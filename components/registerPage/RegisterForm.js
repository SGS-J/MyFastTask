...
export default function RegisterForm(params) {
   ...
   const handleChangeColor = color => {
      setInputValues({ ...inputValues, UIColor: color.hex });
   };
            ...
            >
               <div className="row">
                  ...
                  <div className="row input-field col s12 m6">
                     <h6 className="col s6 grey-text text-darken-1">Favorite Color:</h6>
                     <div className="col s3">
                        <ColorPicker color={inputValues.UIColor} onChangeHandler={handleChangeColor}/>
                     </div>
                  </div>
